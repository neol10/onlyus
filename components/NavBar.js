  ...
  return (
    <>
      <header className="topbar-shell hidden sm:block">
        <div className="nav-container flex items-center justify-between gap-4 py-3 sm:py-4">
          ...
          <nav className="flex items-center gap-2 lg:gap-4">
            <NavIcon active={currentPath === '/'} path="/" label="Início">
            ...
            <NavIcon active={currentPath === '/pet'} path="/pet" label="Pet">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zM4 4h3a3 3 0 006 0h3a2 2 0 012 2v9a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm2.5 7a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm7 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM8 14a2 2 0 014 0h2a4 4 0 10-8 0h2z" /></svg>
            </NavIcon>
      ...
      <nav className="bottombar-shell sm:hidden flex items-center justify-around">
        <NavIcon active={currentPath === '/'} path="/" label="Início">
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
        </NavIcon>
        <NavIcon active={currentPath === '/timeline'} path="/timeline" label="Timeline">
        ...
        <NavIcon active={currentPath === '/pet'} path="/pet" label="Pet">
          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zM4 4h3a3 3 0 006 0h3a2 2 0 012 2v9a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm2.5 7a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm7 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM8 14a2 2 0 014 0h2a4 4 0 10-8 0h2z" /></svg>
        </NavIcon>
        <NavIcon active={currentPath === '/settings'} path="/settings" label="Ajustes">
